...
export const environment = {
  ...
  url_MsAuthention: 'https://msauthentication-auc6a9ajccerbndk.eastus2-01.azurewebsites.net/api/',
  url_MSEntidad: 'https://msauthentication-auc6a9ajccerbndk.eastus2-01.azurewebsites.net/api/',
  ...
  url_MSUsuarioyRoles: 'https://msauthentication-auc6a9ajccerbndk.eastus2-01.azurewebsites.net/api/',
};
